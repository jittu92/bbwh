...
<body>
  <main class="auth">
    ...
    <form class="auth-form" autocomplete="off" id="signup-form">
      <!-- Base Url -->
      ...
      <div class="form-group">
        <div class="form-label-group">
          ...
          <div class="msg msg-red msg-user_name m-t-5">Please enter your Full Name</div>
        </div>
      </div>
      <div class="form-group">
        <div class="form-label-group">
      ...
      <div class="form-group">
        <div class="form-label-group">
          <input type="password" id="user_conf_pass" name="user_conf_pass" class="form-control" placeholder="Password"
            autocomplete="off" required/>
          <label for="user_conf_pass">Confirm Password</label>
          <div class="msg msg-red msg-user_pass m-t-5">Please enter your Confirm Password</div>
        </div>
      </div>
      ...
      <div class="text-center pt-3">
        <a href="admin/login" class="link">Login</a>
